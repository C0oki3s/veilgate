...
>
> See [`docs/MODEL_CARD.md`](../../MODEL_CARD.md) for the conceptual
> model documentation.
...
| `burn_in_events` | int | `500` | return 0 until Bayes has seen this many labelled examples |
...
| `max_depth` | int | `8` (≈ ceil(log2(sample_size))) |
